...
export const demoTodayWorkout = {
  ...
  exercises: [
    ...
    },
    {
      ...
      rir: 2,
      rest_seconds: 90,
      last: { load_kg: 28, reps: 10 },
      video_url: "https://www.youtube.com/embed/IODxDxX7oi4",
    },
    {
      id: "we-3",
      exercise_id: "10000000-0000-4000-8000-000000000028",
      name: "Tríceps Pulley",
      sets: 3,
      rep_min: 10,
      rep_max: 12,
      rir: 1,
      rest_seconds: 75,
      last: { load_kg: 25, reps: 12 },
      video_url: "https://www.youtube.com/embed/IODxDxX7oi4",
    },
    {
      id: "we-4",
      exercise_id: "10000000-0000-4000-8000-000000000019",
      ...
      rir: 2,
      rest_seconds: 60,
      last: { load_kg: 10, reps: 15 },
      video_url: "https://www.youtube.com/embed/IODxDxX7oi4",
    },
    {
      id: "we-5",
      exercise_id: "10000000-0000-4000-8000-000000000053",
      name: "Prancha",
      sets: 3,
      rep_min: 30,
      rep_max: 45,
      rir: 1,
      rest_seconds: 45,
      last: { load_kg: 0, reps: 40 },
      video_url: "https://www.youtube.com/embed/IODxDxX7oi4",
    },
    {
      id: "we-6",
      exercise_id: "10000000-0000-4000-8000-000000000004",
